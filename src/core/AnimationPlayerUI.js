...
class AnimationPlayerUI{
    ...
    recreateNavigation(){
        ...
        this.controller.pageIDs.forEach((pageID, pageIndex) => {
            ...
            this.addLocaleToElement(this.getTitleLangKey(pageID), firstChild.querySelector(".tooltiptext"))
            this.addLocaleToElement(this.getTitleLangKey(pageID), firstChild.querySelector(".navigation-item__title"))
    ...
    addInfoText(pageID, title, text){
        ...
        this.addLocaleToElement(this.getTitleLangKey(pageID), info.querySelector("h3"))
        this.addLocaleToElement(this.getInfoLangKey(pageID), info.querySelector(".info__body"))
