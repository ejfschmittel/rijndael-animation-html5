...
class Page9 extends AnimationPage{
    ...
    createAnimationMain(){
        ...
        tl.add(this.moveGroup(gridMovablesYellow.getCol(0), gridLandings.getCol(0), equationMultiplierLandings.cells, {duration: 1}))
        ...
        tl.add(this.moveGroup(gridMovablesPink.getCol(0), gridLandings.getCol(0), equationResultLandings.cells, {duration: .0001}))
        tl.to(gridMovablesPink.getCol(0), {opacity: 1, duration: .5})
        tl.add(this.moveGroup(gridMovablesPink.getCol(0),equationResultLandings.cells, gridLandings.getCol(0), {duration: 1}))
