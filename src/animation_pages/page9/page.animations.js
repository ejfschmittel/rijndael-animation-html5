...
class Page9 extends AnimationPage{
    ...
    init(){
        const {grid, equationResult, equationMultiplier} = this.pageElements
    ...
    createPreFadeIn(){
        ...
        tl.set([...gridMovablesPink.movables, ...gridMovablesYellow.movables], {opacity: 0})
    ...
    createAnimationMain(){
        ...
        const {gridMovablesPink, gridMovablesYellow, equationResultLandings, equationMultiplierLandings, gridLandings} = this.pageElements
